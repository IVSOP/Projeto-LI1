...
yMax2 :: [[Peca]] -> Int
yMax2 [] = 0
yMax2 (h:t) | length h > yMax2 t = length h
            | otherwise = yMax2 t
...
-- TODO -- função inversa de "constroiMapa" que transforma uma lista de peças numa lista com as peças que não "Vazio", juntamente com as suas respetivas coordenadas
desconstroiMapa :: Mapa -> [(Peca, Coordenadas)]
desconstroiMapa [] = []
desconstroiMapa l = [ concat (talvez??) (desconstroiLinha l y) | y <- [0..(yMax2 l)]]
...
{-
-- IDEIA: ORDENAR MAPA ANTES DE TIRAR LINHAS
